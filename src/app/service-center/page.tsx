...
const PARTS: Part[] = [
  ...
  { key: "motherboard", label: "Motherboard", icon: "/images/parts/motherboard.png" },
...
<section className="py-16">
  <div className="content-width mx-auto">
    ...
    ">
      {/* ITEM */}
      {[
        { img: "/images/service/layanan.jpg", title: "Replace VGA & Processor" },
        { img: "/images/service/layanan2.jpg", title: "Software & Hardware" },
        { img: "/images/service/layanan3.jpg", title: "Recovery Windows/Install Ulang" },
        { img: "/images/service/layanan4.jpg", title: "Mati Total & No Display" },
        { img: "/images/service/layanan5.jpg", title: "Cleaning & Re-pasta" },
        { img: "/images/service/layanan6.jpg", title: "Flash IC BIOS/IC KBC" },
        { img: "/images/service/layanan7.jpg", title: "Re-ball IC Chipset VGA & Processor" },
      ].map((item, i) => (
        <div
          key={i}
          className="
...
<section className="flex justify-center items-center mx-auto content-width">
  <div className="flex w-full mx-auto h-[400px] rounded-xl overflow-hidden shadow-lg border">
      ...
      <div className="flex flex-col gap-5 px-10 pb-10 mt-10 text-lg">
        <div className="flex items-start gap-3">
         <FontAwesomeIcon icon={faCheck} className="text-white"/>
          <p className="text-2xl font-medium"><span className="font-extrabold text-2xl">20% Diskon</span> Jasa Servis</p>
        </div>
        <div className="flex items-start gap-3">
         <FontAwesomeIcon icon={faCheck} className="text-white"/>
          <p className="text-2xl font-medium">Free Cleaning & Re-pasta Senilai <span className="font-extrabold text-2xl">350k</span></p>
        </div>
        <div className="flex items-start gap-3">
         <FontAwesomeIcon icon={faCheck} className="text-white"/>
          <p className="text-2xl font-medium"><span className="font-extrabold text-2xl">10% Diskon</span> Sparepart</p>
        </div>
      </div>
    </div>
    ...
    <div className="relative w-1/3">
      <img src="/images/promo.jpg" alt="Promo Image" className="object-cover w-full h-full" />
      <div className="absolute inset-0 bg-blue-700 bg-opacity-40"></div>
      <div className="absolute inset-0 flex flex-col justify-center items-center text-white text-center">
        <h2 className="text-[32px] font-extrabold mb-4">Claim sekarang</h2>
...
<section className="flex justify-center items-center bg-[#F8F8F8] py-10 px-4">
  <div className="flex items-center content-width mx-auto  gap-10">
    ...
    <div className="flex-shrink-0 w-1/3">
      <img src="/images/konsultasi.png" alt="Teknisi Sentral Service" className="object-contain w-full" />
    </div>
    ...
    <div className="flex flex-col text-2xl w-2/3 leading-relaxed text-zinc-900">
      ...
      <p className="mb-2">
        <span className="text-[#1444D5] font-semibold">Hubungi kami</span> hari ini untuk diagnosa awal 
        <span className="text-[#1444D5] font-extrabold"> GRATIS </span> bersama teknisi profesional kami.
      </p>

      <p className="mt-5 text-[#1444D5] font-bold">
        Sentral Service – Layanan service laptop resmi, profesional, dan terpercaya.
      </p>

      <p className="mt-2">
        <span className="text-[22px]">📍</span> Tersedia di seluruh cabang Sentral Komputer.
      </p>
    </div>
      ...
      <div className="content-width mx-auto my-12">
          <p className="text-[10px] text-justify text-gray-400">Sentral Komputer – Pusat Laptop, Komputer, dan Service Resmi Terpercaya di Indonesia Sentral Komputer adalah toko laptop dan komputer terlengkap di Indonesia dengan 18 cabang resmi di Jakarta, Bekasi, Bogor, Karawang, Cikarang, Serang, Purwakarta, Sukabumi, dan Cilegon. Dengan cakupan wilayah yang luas meliputi DKI Jakarta, Jawa Barat, dan Banten, Sentral Komputer menjadi pusat laptop, komputer, aksesoris, serta layanan service terpercaya dengan akses yang mudah dan nyaman di setiap kota. Kami menghadirkan laptop terbaru dari merek ternama seperti Acer, ASUS, Lenovo, HP, MSI, Axioo, dan Zyrex, serta berbagai aksesoris dan peripheral gaming dari Fantech, Rexus, Logitech, dan merek populer lainnya. Semua produk dijamin 100% original dengan garansi resmi, ditambah dengan garansi ADP (Accidental Damage Protection) untuk perlindungan ekstra terhadap kerusakan akibat kecelakaan seperti jatuh, terkena cairan, atau benturan. Bahkan, beberapa produk pilihan sudah dilengkapi ADP gratis, sehingga pelanggan mendapatkan keuntungan lebih tanpa biaya tambahan. Selain jaringan toko offline, Sentral Komputer juga menyediakan platform belanja online yang aman, cepat, dan praktis. Dengan dukungan sistem pembayaran terpercaya, opsi pengiriman fleksibel, dan customer support yang responsif, pengalaman belanja laptop, komputer, dan aksesoris menjadi lebih nyaman kapan saja dan di mana saja. Untuk layanan purna jual, Sentral Service hadir sebagai pusat service center resmi terpercaya dengan teknisi bersertifikat. Kami memberikan layanan perawatan, perbaikan, dan upgrade perangkat dengan sparepart resmi bergaransi, harga terjangkau, serta pilihan service onsite maupun bisa ditunggu langsung di tempat. Semua merek laptop dapat ditangani, termasuk layanan cleaning dan repasta murah untuk menjaga performa laptop tetap optimal. Tidak hanya untuk konsumen individu, Sentral Komputer juga melayani B2B, korporasi, koperasi, sekolah, universitas, hingga proyek pemerintah dengan solusi pengadaan perangkat teknologi yang lengkap dan terpercaya. Sebagai toko laptop dan komputer terbaik, ternyaman, terbagus, dan terlengkap, Sentral Komputer memberikan pilihan produk yang sangat banyak, promo menarik, free gift melimpah, serta pelayanan sales yang ramah dan profesional. Dengan reputasi terpercaya, pengalaman panjang, dan harga yang bersahabat, Sentral Komputer adalah destinasi utama untuk semua kebutuhan laptop, komputer, dan IT di Indonesia.</p>
      </div>
      </div>
      <Footer />
    </>
